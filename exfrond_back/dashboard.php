...
<center>
	...
	<button type="button" id="registro" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">
  	Nuevo Producto
	</button>
...
<button type="button"  id="registrar" class="btn btn-dark">Registrar usuario </button>	
    <!-- Footer -->
    <footer class="footer bg-dark">
    <div class="container">
        <p class="m-0 text-center text-white" ><b> UC: Desarrollo de aplicaciones web y móviles   [ alumnos Victor Manuel, Paulino Enrique y Keyla Yoselin  ] </b></p>
    </div>
    </footer>
